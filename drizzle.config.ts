...
export default defineConfig({
  ...
  schema: [
    ...
    './src/db/schema/mini_app_password_resets.ts',
    ...
    './src/db/schema/support_bot_confirmations.ts',
    './src/db/schema/support_bot_gateway_leases.ts',
    './src/db/schema/support_bot_knowledge_articles.ts',
    ...
    './src/db/schema/bulk_change_log.ts',
    ...
    './src/db/schema/agent_blackboards.ts',
    './src/db/schema/agent_skills.ts',
    ...
    './src/db/schema/mytrion_role_defaults.ts',
    './src/db/schema/worker_mytrion_access.ts',
    './src/db/schema/worker_profiles.ts',
    ...
    './src/db/schema/loyalty_client_overrides.ts',
    ...
    './src/db/schema/hr_leave_types.ts',
    './src/db/schema/hr_leave_entitlements.ts',
    './src/db/schema/hr_holidays.ts',
    './src/db/schema/hr_leave_settings.ts',
    './src/db/schema/hr_leave_requests.ts',
    './src/db/schema/hr_leave_request_actions.ts',
    ...
    // 0101/0102/0103 are therefore hand-written idempotent SQL. Re-adding a file here without
    // first reconciling the snapshot will reproduce that.
  ],
