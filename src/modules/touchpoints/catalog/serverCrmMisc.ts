...
export const serverCrmMiscTouchpoints: Touchpoint[] = [
  ...
  },
  {
    kind: 'servercrm',
    key: 'efs.card_status',
    title: 'Activate / deactivate card in live EFS',
    riskClass: 'destructive',
    departments: SALES,
    carrierParam: 'carrierId',
    method: 'POST',
    pathTemplate: '/api/efs/card/status',
  ...
  },
  {
    kind: 'servercrm',
    key: 'efs.card_limits',
    title: 'Increase / decrease a live EFS card limit',
    riskClass: 'destructive',
    departments: SALES,
    carrierParam: 'carrierId',
    method: 'POST',
    pathTemplate: '/api/efs/card/limits',
    paramsSchema: z.object({
      carrierId,
      cardNumber,
      limitId: shortText(40),
      // This is a delta added to/subtracted from the existing limit, never an absolute replacement.
      value: z.coerce.number().positive().max(350),
