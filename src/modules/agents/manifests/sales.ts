...
import { CLIENT_SERVICE_RULE,
  ...
  OWNER_SCOPE_RULE,
  RAG_USAGE_RULE,
  STAY_IN_LANE, ANALYTICS_TOOLS, WAREHOUSE_TOOLS } from './shared.js';
...
const SALES_CAPABILITIES =
  ...
  'pumped by the carriers in YOUR book, resolved from your session id. Use it for "my gallons", ' +
  '"how many gallons/swipes did my clients do"; never ask for your name or id, and never report ' +
  'another agent’s totals.\n' +
...
export const salesAgent: AgentManifest = {
  ...
  tools: ['agent.sales_snapshot', 'agent.activity', 'zoho_crm.query', ...CLIENT_SERVICE_TOOLS, ...FILE_TOOLS, ...ANALYTICS_TOOLS, ...WAREHOUSE_TOOLS],
  composioToolkits: [],
