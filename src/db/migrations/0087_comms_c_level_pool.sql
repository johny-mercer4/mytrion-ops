-- 0087: escalation level 4 is a POOL (CEO + COO), not a single configured user.
--
-- 0086 put `c_level_zoho_user_id` on mytrion_comms_settings on the assumption that C-Level was one
...
--
-- Appended rather than amending 0086 so anyone who already applied it moves forward safely.
