> **Historical archive.** Pre-Horizon / Zoho-embedded widget era. Do not implement from this file.
> Incumbent spec: `docs/design/DESIGN_SYSTEM.md`, `apps/mytrion-crm/src/styles/theme.css`,
> `apps/mytrion-crm/src/ds/CONVENTIONS.md`.
