> **Status:** STALE (checked 2026-08-21). `listDwhCardsAll` was never added. Fleet/status shipped
> EFS-first (`listLiveCardRows`, inactive included) instead. Do not implement this spec as written.
