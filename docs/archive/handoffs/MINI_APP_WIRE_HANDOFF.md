> **Status:** SHIPPED (checked 2026-08-21). Backend `carrierMiniAppActions.routes.ts` and
> mini-app money-code / card sheets exist. This is a completed session task list, not the live
> contract — read the code. `WORKING_NOTES.md` is local scratch.
