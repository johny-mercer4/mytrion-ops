...
license: MIT
compatibility: Requires agent-gateway runtime + mcp octane_* tools + telegram_read_image.
---
...
1. `telegram_read_image` — read the photo. Card number is embossed/printed; note the
   LAST 6 digits only.
