...
license: MIT
compatibility: agent-gateway runtime; pairs with octane-customer-service and octane-communication.
---
...
(actions: override, moneycode, funds, txns, pinunit, status, invoices, cardops, manualcode).
