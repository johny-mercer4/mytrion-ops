...
const badgeVariants = cva(
  // rounded-full, not the stray rounded-4xl it used to carry: at 32px on a 20px-tall badge that
  // was already rendering as a pill, but via a value from outside the app's radius scale.
