        ...
        {filtered.length === 0 ? (
          ...
          filtered.map((e) => {
            ...
            return (
              ...
              >
                <span
                  className={`flex size-9 flex-none items-center justify-center rounded-xs ${isDeadZone ? 'bg-bad/12 text-bad' : 'bg-good/12 text-good'}`}
                >
                ...
                <span className="min-w-16 flex-none rounded-xs bg-secondary px-1.5 py-0.5 text-center font-mono text-[10.5px] font-bold text-secondary-foreground">
