...
export const AUTO_LIST: readonly Automation[] = [
  ...
  { id: 'view-manage-cards', title: 'Card Status Report', codes: ['C-30'], dept: 'C', icon: ICO.card, color: 'var(--accent-2)', desc: 'View a carrier’s live card roster and download the Card Lookup report as PDF or Excel.', top: true, kind: 'card-report', verb: 'Get Report' },
