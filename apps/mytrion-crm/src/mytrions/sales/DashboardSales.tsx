  ...
  return (
    <div className="flex flex-col gap-3.5">
      ...
      <div className="grid grid-cols-1 gap-3 lg:grid-cols-3">
        <div className="flex items-center justify-around rounded-xs border bg-card p-5">
        ...
        <div className="flex flex-col justify-center gap-2.5 rounded-xs border bg-card p-5">
          <div className="flex items-center justify-between rounded-xs border bg-muted/30 px-3 py-2 text-sm">
