  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4">
        ...
        <Field label="Carrier">
          <div className="rounded-md border bg-muted/40 px-3 py-2 text-sm font-semibold">{DEMO_CARRIER}</div>
        </Field>
          ...
          <div className="grid grid-cols-2 gap-3">
            <Field label="From">
              <input
                ...
                className="w-full rounded-md border bg-muted/40 px-3 py-2 text-sm outline-none focus:border-primary/55 focus:ring-3 focus:ring-primary/12"
              />
            </Field>
            <Field label="To">
              <input
