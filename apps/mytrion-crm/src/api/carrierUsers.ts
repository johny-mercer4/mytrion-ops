...
/** An existing servercrm (CMP) operator login — what an owner account binds TO. */
 ...
 * sent-but-maybe-never-opened invite (CarrierInvitation) and from the old login-based CarrierUser. */
